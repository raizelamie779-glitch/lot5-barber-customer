        ...
        try {
            ...
            waitingList.sort((a, b) => {
                ...
                if (scoreA === 1 || scoreA === 3) {
                    ...
                    const timeA = new Date(a.queue_timestamp);
                    const timeB = new Date(b.queue_timestamp);
                    return timeA - timeB;
                }
            });
            ...
            while (waitingList.length > 0) {
                ...
                if (first.appoint_type === 'walk-in') {
                    const joinedTime = new Date(first.queue_timestamp);
